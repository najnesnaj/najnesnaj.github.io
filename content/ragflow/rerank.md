...
<a id="ragflow-models"></a>

# example:

curl -X POST [http://localhost:8000/v1/rerank](http://localhost:8000/v1/rerank) 
...
2. **Reranker**
   ...
   ![RAGFlow reranking process illustration](/images/ragflow/rerank.png)
3. **Chat Model (LLM)**
