...
For implementation details, refer to the official guide at [https://github.com/infiniflow/ragflow/blob/main/docs/guides/dataset/construct_knowledge_graph.md](https://github.com/infiniflow/ragflow/blob/main/docs/guides/dataset/construct_knowledge_graph.md). To experiment, deploy RAGFlow via Docker and enable KG in your knowledge base settings.
