...
curl –request POST 
: –url [http:/](http:/)/{address}/api/v1/datasets/{dataset_id}/run_graphrag –header ‘Authorization: Bearer <YOUR_API_KEY>’

-> get dataset ID

> curl -H “Authorization: Bearer ragflow-_FdZQN68Q1NgLLeLmKe-3qbGHv15fqXg2AfJRENBIIw”         [http://192.168.0.213/api/v1/datasets](http://192.168.0.213/api/v1/datasets)
...
curl –request POST 
: –url [http://192.168.0.213/api/v1/datasets/0fbeb780b40d11f0bf690242ac170006/run_graphrag](http://192.168.0.213/api/v1/datasets/0fbeb780b40d11f0bf690242ac170006/run_graphrag) –header “Authorization: Bearer ragflow-_FdZQN68Q1NgLLeLmKe-3qbGHv15fqXg2AfJRENBIIw”
