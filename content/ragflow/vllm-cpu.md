...
[https://github.com/vllm-project/vllm/blob/main/docker/Dockerfile.cpu](https://github.com/vllm-project/vllm/blob/main/docker/Dockerfile.cpu)
...
- **\`\`image: vllm-cpu:latest\`\`**
  ...
  - Built from: [vllm-project/vllm/docker/Dockerfile.cpu](https://github.com/vllm-project/vllm/blob/main/docker/Dockerfile.cpu)
